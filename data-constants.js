...
var EXES = [
  ...
  {n:"坐姿腿屈伸", m:"腿", eq:"gym", diff:"初级", desc:"坐姿腿屈伸，孤立股四头肌", tips:"调整靠背使膝盖对准转轴，抬起至腿伸直停顿1秒，控制下放", vid:""},
  {n:"俯卧腿弯举", m:"腿", eq:"gym", diff:"初级", desc:"俯卧腿弯举，孤立腘绳肌", tips:"髋部贴紧垫子，脚跟勾向臀部，顶端挤压1秒，缓慢回放", vid:""},
  {n:"史密斯深蹲", m:"腿", eq:"gym", diff:"初级", desc:"史密斯机深蹲，轨迹固定适合新手学深蹲", tips:"调整杠位高度，脚略前于杠，下蹲至大腿平行，膝盖不内扣", vid:""},
  ...
  {n:"蝴蝶机夹胸", m:"胸", eq:"gym", diff:"初级", desc:"蝴蝶机夹胸，固定轨迹孤立胸肌", tips:"调整座椅使握把与胸齐平，夹至胸前停顿1秒，缓慢回放", vid:""},
  {n:"上斜史密斯机卧推", m:"胸", eq:"gym", diff:"初级", desc:"史密斯机上斜推胸，轨迹固定适合新手练上胸", tips:"椅背30-45°，杆下落至锁骨上方，肩胛收紧，顶端不完全锁死", vid:""},
  ...
  {n:"单臂绳索划船", m:"背", eq:"gym", diff:"初级", desc:"单臂绳索划船，单侧背部训练", tips:"对侧手扶稳，背部平直，把绳索向腰侧拉，肩胛夹紧", vid:""},
  // 背部 - 中级
  ...
  {n:"器械肩推", m:"肩", eq:"gym", diff:"初级", desc:"坐姿器械推肩，轨迹固定安全练三角肌", tips:"调整座椅使把手与肩同高，推起时不要完全锁死肘部", vid:""},
  {n:"器械侧平举", m:"肩", eq:"gym", diff:"初级", desc:"器械侧平举，孤立三角肌中束打造宽肩", tips:"轻重量起步，手肘微弯，不要耸肩借力", vid:""},
  {n:"史密斯肩推", m:"肩", eq:"gym", diff:"初级", desc:"史密斯机肩推，轨迹固定适合新手", tips:"杆推至头顶略微前倾，腰背保持中立，不要过度后仰", vid:""},
  // 肩部 - 中级
  ...
  {n:"坐姿弯举机", m:"臂", eq:"gym", diff:"初级", desc:"坐姿弯举机，固定轨迹孤立二头肌", tips:"上臂贴紧靠垫，只靠二头收缩发力，顶端挤压1秒", vid:""},
  {n:"绳索弯举", m:"臂", eq:"gym", diff:"初级", desc:"绳索弯举，持续张力刺激二头肌", tips:"肘部固定在体侧，绳索拉向肩部，顶端停顿，控制回放", vid:""},
  {n:"绳索过顶臂屈伸", m:"臂", eq:"gym", diff:"初级", desc:"绳索过顶臂屈伸，针对三头长头", tips:"背对绳索双手过头抓握，肘部指向天花板，伸直手臂", vid:""},
  ...
  // 有氧 — 哑铃 HIIT
  {n:"哑铃火箭推", m:"有氧", eq:"dumbbell", diff:"中级", desc:"深蹲+推举一体，全身爆发HIIT", tips:"下蹲后站起顺势将哑铃推过头顶，连续做30秒一组，心率飙升", vid:""},
  {n:"哑铃摆壶", m:"有氧", eq:"dumbbell", diff:"中级", desc:"哑铃版壶铃swing，臀腿驱动+心肺", tips:"双手握一只哑铃，髋部爆发向前摆，不用手臂发力，30秒一组", vid:""},
  {n:"哑铃复合推", m:"有氧", eq:"dumbbell", diff:"中级", desc:"深蹲+弯举+推举连续，耐力+心肺", tips:"一次完成深蹲→弯举→推举，不间歇连续做，15次为一组", vid:""},
  // 有氧 — 高级 HIIT
  {n:"哑铃抓举", m:"有氧", eq:"dumbbell", diff:"高级", desc:"单臂爆发抓举，全身参与", tips:"哑铃从地面直接过头，髋部发力，左右交替各10次", vid:""},
